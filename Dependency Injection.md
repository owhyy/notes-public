...
- Main idea: _Make the I/O function/library a parameter_. Now you can plug in any other I/O library function.
...
- Testing is done via _simulating one of the dependencies_:
